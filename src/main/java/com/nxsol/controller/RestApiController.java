...
import com.nxsol.util.CustomErrorType;
...
public class RestApiController {
	...
	@RequestMapping(value = "/deletByQuery/user/{id}", method = RequestMethod.DELETE)
	public ResponseEntity<?> deleteByQuery(@PathVariable("id") long id) {
		logger.info("Fetching & Deleting User with id {}", id);
